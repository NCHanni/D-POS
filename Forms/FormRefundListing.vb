Friend Class FormRefundListing
...
#Region "Event Handlers"
                ...
                For Each column In .Columns
                    With column
                        Select Case .Key
                            ...
                            Case "sale_code", "refund_code"
                                .SetWidth(100)
                            Case "cr_code"
                                .Header.Caption = "Return Code"
                                .Header.ToolTipText = "Customer Return Code"
                                .SetWidth(100)
                            Case "customer"
                            Case "total_amount"
                    ...
                    For Each column In .Columns
                        With column
                            Select Case .Key
                                Case "description"
                                    .Header.Caption = "Item"
                                Case "quantity", "unit_price", "amount"
                                    .CellAppearance.TextHAlign = Infragistics.Win.HAlign.Right
                                    .Format = "#,##0.00"
                                    .Style = Infragistics.Win.UltraWinGrid.ColumnStyle.DoubleNonNegative
                                    Select Case .Key
    ...
    Private Sub txtSearch_ValueChanged(sender As Object, e As EventArgs) Handles txtSearch.ValueChanged
        Try
            Dim searchKeys As String = "sale_code,cr_code,refund_code,customer,cashier"
...
#Region "Methods"
    ...
    Private Sub RefreshList()
        Try
            With New SalesList
                grdList.DataSource = .GetListRefund(dateRange.StartDate, dateRange.EndDate)
                txtSearch.Clear()
            End With
