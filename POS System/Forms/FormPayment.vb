...
#Region "Methods"
    ...
    Private Sub Initialize()
        Try
            ...
            numCashAmount.MaxValue = 999999.99
    ...
    Private Sub ComputeTotal()
        Try
            ...
            Dim creditMemoAmount As Double = 0.0
    ...
    Private Function IsValid() As Boolean
        Try
            ...
            If Math.Round(totalAmountPaid, 2) < m_TotalSales Then
                ...
                Return False
            ElseIf (totalAmountPaid - numCashAmount.Value) > m_TotalSales Then
